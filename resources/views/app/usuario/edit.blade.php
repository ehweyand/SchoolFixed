    ...
    <div class="container">
        <form action="{{ route('usuario.update', ['usuario' => $usuario->id]) }}" method="post">
            ...
            <div class="row">
                ...
                <div class="col-75">
                    <input type="text" id="email"  name="email" value="{{ $usuario->email ?? old('email') }}">
                    {{-- Mensagem de aviso --}}
            ...
            <div class="row">
                ...
                <div class="col-75">
                    <input type="text" id="senha" name="senha" value="{{ $usuario->senha ?? old('senha') }}">
                    {{-- Mensagem de aviso --}}
            ...
            <div class="row">
                ...
                <div class="col-75">
                    <select name="permissao" value="{{ $usuario->permissao ?? old('permissao') }}">
                    <option value="1" {{ $usuario->permissao == 1 ? 'selected' : '' }}>Administrador</option>
                    <option value="2" {{ $usuario->permissao == 2 ? 'selected' : '' }}>Cliente</option>
                    </select> 
                    {{-- Mensagem de aviso --}}
        ...
        <div class="row centered">
            <button class="button-generic button-return" onclick="window.location='{{ url('app/usuario') }}'">Voltar</button>
        </div>
    </div>
    </div>

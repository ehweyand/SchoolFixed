    ...
    <div class="container">
        <form action="{{ route('tipo_servico.update', ['tipo_servico' => $tipo_servico->id]) }}" method="post">
            ...
            <div class="row">
                ...
                <div class="col-75">
                    <input type="text" id="descricao" name="descricao" value="{{ $tipo_servico->descricao ?? old('descricao') }}">
        ...
        <div class="row centered">
            <button class="button-generic button-return" onclick="window.location='{{ url('app/tipo_servico') }}'">Voltar</button>
        </div>
    </div>
    </div>

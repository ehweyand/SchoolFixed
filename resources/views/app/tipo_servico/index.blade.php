...
<body>
    ...
    <!--========== CONTENTS ==========-->
    <div class="container">
        <form action="{{ route('tipo_servico.store') }}" method="post">
            @csrf
            <div class="row">
                <div class="col-25">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a class="green-text" href="{{ route('tipo_servico.edit', ['tipo_servico' => $tipo_servico->id])}}"><i class='bx bx-highlight nav__icon'></i> Editar</a></td>

                    <td>
                        <form id="form_{{$tipo_servico->id}}" method="post" action="{{ route('tipo_servico.destroy', ['tipo_servico' => $tipo_servico->id])}}">
                            @method('DELETE')
                            @csrf
                            <a href="#" class="red-text" onclick="document.getElementById('form_{{$tipo_servico->id}}').submit()"><i class='bx bx-trash-alt nav__icon'></i> Excluir</a>
                        </form>
                    </td>
                </tr>
